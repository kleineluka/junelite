...
float inputSat, float inputLight)
{
    ...
    // attribution: my implementation of "sinebow" by jim bumgardner (@jbum)
...
float getBayerValue(float2 screenPos) {
	// get bayer dithering value for dithering blurs
    const float bayer_matrix_4x4[16] = {
        0.0 / 16.0, 8.0 / 16.0, 2.0 / 16.0, 10.0 / 16.0,
        12.0 / 16.0, 4.0 / 16.0, 14.0 / 16.0, 6.0 / 16.0,
        3.0 / 16.0, 11.0 / 16.0, 1.0 / 16.0, 9.0 / 16.0,
        15.0 / 16.0, 7.0 / 16.0, 13.0 / 16.0, 5.0 / 16.0
    };
    int x = uint(screenPos.x) % 4;
    int y = uint(screenPos.y) % 4;
    return bayer_matrix_4x4[y * 4 + x];
}
