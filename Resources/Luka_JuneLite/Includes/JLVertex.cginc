...
struct v2f {
	...
	float2 zoom : TEXCOORD1;
	float2 precalculations : TEXCOORD2;
	float4 postcalculations : TEXCOORD3;
	float4 overlayCoordinates : TEXCOORD4;
	#ifdef _KEYWORD_ENABLE_LITE_FOG
		float4 worldDir : TEXCOORD5;
		float3 worldPos : TEXCOORD6;
		float3 rayCast : TEXCOORD7;
...
_LiteUVManipulationSpherizePower;
#endif

//|===============================================|
//|			   vertex kernel					  |
//|===============================================|
v2f vert(appdata_base v, appdata p, float4 pos : POSITION) {
	v2f o = (v2f)0;
	...
	if (o.precalculations.x < _LiteRenderingFalloffEnd) {
        ...
        #endif  // _KEYWORD_ENABLE_LITE_ZOOM
		#ifdef _KEYWORD_ENABLE_LITE_UV_MANIPULATION
