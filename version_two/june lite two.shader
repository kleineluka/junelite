...
Shader "luka/june_lite/two"
{
    Properties
    {
        ...
        _LiteFogDensity ("Fog Density", Range(0, 10)) = 1
        _LiteFogDistribution ("Fog Distribution", Range(0, 10)) = 1
    ...
    SubShader
    {
		...
		//|				 lite pass					      |
		//|===============================================|
        GrabPass { Tags {"LightMode" = "ForwardBase" } "_LukaJuneLitePass" }
        Pass
        {
	...
	FallBack "Diffuse"
	CustomEditor "JuneLite.LukaJuneLiteUITwo"
}
